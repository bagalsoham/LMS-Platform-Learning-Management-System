...
class EnrolledCourseController extends Controller
{
    function index() : View
    {
        ...
        return view('frontend.student.enrolled-course.index', compact('enrollments'));
    }
    ...
    function playerIndex(string $slug) : View
    {
        ...
        return view('frontend.student.enrolled-course.player-index', compact('course', 'lastWatchHistory', 'watchedLessonIds', 'lessonCount'));
    }
