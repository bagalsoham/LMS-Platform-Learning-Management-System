                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#razorpay-setting" class="nav-link" data-bs-toggle="tab" aria-selected="true"
                                        role="tab">Razorpay Settings</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="paypal_mode" class="form-control">
                                                        <option
                                                            @selected(config('gateway_settings.paypal_mode') === 'sandbox')
                                                            value="sandbox">Sandbox</option>
                                                        <option @selected(config('gateway_settings.paypal_mode') === 'live')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="paypal_currency" class="form-control select2">
                                                        @foreach(config('gateway_currencies.paypal_currencies') as $key => $value)
                                                            <option
                                                                @selected(config('gateway_settings.paypal_currency') == $value['code'])
                                                                value="{{ $value['code'] }}">{{ $value['code'] }}</option>
                                                        @endforeach
                                                    </select>

                                                    <x-input-error :messages="$errors->get('paypal_currency')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <x-input-error :messages="$errors->get('paypal_client_id')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <x-input-error :messages="$errors->get('paypal_client_secret')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="stripe_status" class="form-control">
                                                        <option
                                                            @selected(config('gateway_settings.stripe_status') === 'active')
                                                            value="active">Active</option>
                                                        <option
                                                            @selected(config('gateway_settings.stripe_status') === 'inactive')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="stripe_currency" class="form-control select2">
                                                        @foreach(config('gateway_currencies.stripe_currencies') as $key => $value)
                                                            <option
                                                                @selected(config('gateway_settings.stripe_currency') == $value)
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="razorpay_status" class="form-control">
                                                        <option
                                                            @selected(config('gateway_settings.razorpay_status')==='active'
                                                            ) value="active">Active</option>
                                                        <option
                                                            @selected(config('gateway_settings.razorpay_status')==='inactive'
                                                            ) value="inactive">Inactive</option>
                                                    </select>
                                                    <x-input-error :messages="$errors->get('razorpay_status')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="razorpay_currency" class="form-control select2">
                                                        @foreach(config('gateway_currencies.razorpay_currencies') as $key =>
                                                        $value)
                                                        <option
                                                            @selected(config('gateway_settings.razorpay_currency')==$value)
                                                            value="{{ $value }}">{{ $value }}</option>
                                                        @endforeach
                                                    </select>

                                                    <x-input-error :messages="$errors->get('razorpay_currency')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <x-input-error :messages="$errors->get('razorpay_secret')"
                                                        class="mt-2" />
                                                </div>
                                            </div>
