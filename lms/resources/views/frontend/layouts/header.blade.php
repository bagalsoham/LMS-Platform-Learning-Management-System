@php
    ...
    // Get current route name for active class logic
...
<nav class="navbar navbar-expand-lg main_menu main_menu_3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav m-auto">
            <li class="nav-item">
                <a class="nav-link {{ $currentUrl === url('/') ? 'active' : '' }}" href="{{ url('/') }}">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains($currentRoute, 'courses.') ? 'active' : '' }}" href="{{ route('courses.index') }}">Courses</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains($currentRoute, 'about.') ? 'active' : '' }}" href="{{ route('about.index') }}">About</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains($currentRoute, 'blog.') ? 'active' : '' }}" href="{{ route('blog.index') }}">Blogs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains($currentRoute, 'contact.') ? 'active' : '' }}" href="{{ route('contact.index') }}">Contact Us</a>
            </li>
            @foreach ($customPages as $page)
                <li class="nav-item">
                    <a class="nav-link {{ $currentRoute === 'custom-page' && request()->route('slug') === $page->slug ? 'active' : '' }}"
